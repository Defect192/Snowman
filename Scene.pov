...
//------PHASE ONE   (snowman moving away from camera
...
object { snowman rotate y*180 translate <0,-3.5,clock/2> scale 0.25 }




//-------PHASE TWO (snowman moving right to off screen)
...
object { snowman rotate y*-90 translate <clock*(41/142),-3.5,72> scale 0.25 }   
*/



//------PHASE THREE (snowman flying to top-left corner) 
...
object { snowman rotate y*90 rotate z*45 translate <(41-(clock*(82/70))),(-3.5+(clock*(23.5/70))),72> scale 0.25 }
*/


//------PHASE FOUR  (snowman flying into distance + camera change)

/*
camera {
  location  <-1.0, 4.0, 22.0>
  direction 1.5*z
  right     x*image_width/image_height
  look_at   <-4.0, 4.0,  20.0>   
}
object { snowman rotate y*90 rotate z*45 translate <(-35-(clock*(82/70))),(18+(clock*(23.5/70))),60> scale 0.25 }
*/
